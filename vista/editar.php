<?php  
	require '../controlador/datos_user.php';
?>
...
<body>
	...
	<div class="formulario_fondo">
        <div class="reg-sesion">
    		<h3 class="registro ">Editar Información Del Usuario</h3>
	   </div>
 	<form action="#" method="POST">
        ...
        <fieldset class="scheduler-border">
            ...
            value="<?php echo $resultado['nombre_completo']; ?>" required />
        </fieldset>
        <fieldset class="scheduler-border">
        ...
        <fieldset class="scheduler-border">
                ...
                value="<?php echo $resultado['edad']; ?>" required/>
         </fieldset>
        <fieldset class="scheduler-border" class="icono-s">
                ...
                value="<?php echo $resultado['sexo']; ?>" required/>
        </fieldset>
         <fieldset class="scheduler-border">
                <legend class="scheduler-border"> Editar Información <i class="fa fa-envelope"></i></legend>
                <input type="submit" name="editar" value="Enviar" class="btn-primary form-control">
        </fieldset> 
    <?php } ?>
 	</form>
 </div>
