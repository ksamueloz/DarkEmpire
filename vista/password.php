<?php  
	require '../controlador/cambiar_password.php';
?>
...
<body>
    ...
    <div class="formulario_fondo">
        <div class="reg-sesion">
            <h1 class="registro"> Cambia tu contraseña</h1>
        </div>
        <form action="../controlador/cambiar_password.php" method="post" class="formulario">
            <fieldset class="scheduler-border">
                <legend class="scheduler-border">Contraseña <i class="fa fa-key"></i></legend>
                <input type="password" name="pass1" placeholder="Contraseña" class="form-control" required/>
            </fieldset>
            <fieldset class="scheduler-border">
                <legend class="scheduler-border">Repite La Contraseña <i class="fa fa-key"></i></legend>
                <input type="password" name="pass2" placeholder="Contraseña" class="form-control" required/>
            </fieldset>
            <fieldset class="scheduler-border">
                <legend class="scheduler-border">Actualizar Contraseña <i class="fas fa-sign-in-alt"></i></i></legend>
                <input type="submit" name="cambiarPassword" value="Enviar" class="btn-primary form-control">
            </fieldset>
