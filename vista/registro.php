<?php 
    require '../controlador/logica_registro.php';
?> 
                                        ...
                                        <?php }else if($_SESSION['$nombre']=="Administrador"){ ?> 
                                            <li><a href="#">Opciones</a>
                                                <ul class="dropdown">
                                                    ...
                                                    <li><a href="../controlador/cambiar_password.php">Cambiar contraseña</a></li>
                                                    <li><a href="../controlador/salir.php">Cerrar Sesion</a></li>
                                                </ul>
                                            </li>
        ...
        if ($_SESSION['$nombre'] == 'Administrador'){?>
            <div class="formulario_fondo">
                <div class="reg-sesion">
                    <h1 class="registro ">Registra un nuevo usuario</h1>
               </div>
               <!-- <form action="registro.php" method="post"> -->
            <form action="registro.php" method="POST">
                <?php
                    if(isset($_POST['registrar'])){
                        include_once '../vista/registro_valido.php';
                    }else{
                        include_once '../vista/registro_vacio.php';
                    }
                ?>
            </form>
         </div>  
    <?php } }else {  ?> 
        <div class="formulario_fondo">
                <div class="reg-sesion">
                    ...
                    <span class="registro"><a href="login.php" id="red">o Inicia Sesión</a></span>
               </div>
                   <!-- <form action="registro.php" method="post"> -->
                <form action="registro.php" method="POST">
                    <?php
